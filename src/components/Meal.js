...
const Meal = ({ meal }) => {
    ...
    return (
        <div className='bg-white rounded shadow-lg flex flex-wrap m-auto'>
            <div className='w-1/3'>
                <img className='w-full h-full lg:h-64 rounded rounded-r-none  object-cover' src={strMealThumb} alt={strMeal}/>
            </div>
            <div className='w-2/3 p-5 relative'>
                <h3 className='text-2xl font-semibold text-blue-900'>{strMeal}</h3>
